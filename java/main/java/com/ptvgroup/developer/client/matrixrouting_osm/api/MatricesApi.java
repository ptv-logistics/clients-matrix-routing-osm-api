...
public class MatricesApi {
   ...
   * @param profile A profile defines a vehicle by a set of attributes, matching typical transport situations. It must be the name of one of the [predefined profiles](../data-api/concepts/osm-profiles) such as _SEMITRAILER_OSM_. (optional, default to SEMITRAILER_OSM)
