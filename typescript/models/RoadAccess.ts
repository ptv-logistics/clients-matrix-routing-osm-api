...
/**
 * Use these coordinates for matching to the nearest road. Implies **includeLastMeters**, i.e.
 * the air-line connection between the location coordinates and the matched coordinates
 * is included in the relation distance and travel time.
 * This is useful if the location should not be matched to the nearest possible road but to some road further away,
