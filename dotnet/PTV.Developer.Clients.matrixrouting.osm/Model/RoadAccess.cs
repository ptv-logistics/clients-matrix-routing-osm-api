...
namespace PTV.Developer.Clients.matrixrouting.osm.Model
{
    ...
    public partial class RoadAccess : IValidatableObject
    {
        ...
        public RoadAccess(double? latitude = default(double?), double? longitude = default(double?))
        {
            ...
            if (latitude == null)
            {
                throw new ArgumentNullException("latitude is a required property for RoadAccess and cannot be null");
            }
            this.Latitude = latitude;
            // to ensure "longitude" is required (not null)
            if (longitude == null)
            {
                throw new ArgumentNullException("longitude is a required property for RoadAccess and cannot be null");
            }
