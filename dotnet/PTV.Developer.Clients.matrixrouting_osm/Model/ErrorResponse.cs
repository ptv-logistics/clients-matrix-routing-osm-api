...
namespace PTV.Developer.Clients.matrixrouting_osm.Model
{
    ...
    public partial class ErrorResponse : IEquatable<ErrorResponse>, IValidatableObject
    {
        ...
        public ErrorResponse(string description = default(string), string errorCode = default(string), string traceId = default(string), string errorId = default(string), List<CausingError> causes = default(List<CausingError>), Dictionary<string, Object> details = default(Dictionary<string, Object>))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for ErrorResponse and cannot be null");
            // to ensure "errorCode" is required (not null)
            this.ErrorCode = errorCode ?? throw new ArgumentNullException("errorCode is a required property for ErrorResponse and cannot be null");
            // to ensure "traceId" is required (not null)
            this.TraceId = traceId ?? throw new ArgumentNullException("traceId is a required property for ErrorResponse and cannot be null");
