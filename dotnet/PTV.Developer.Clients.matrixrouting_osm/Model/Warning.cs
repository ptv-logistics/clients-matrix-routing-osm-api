...
namespace PTV.Developer.Clients.matrixrouting_osm.Model
{
    ...
    public partial class Warning : IEquatable<Warning>, IValidatableObject
    {
        ...
        public Warning(string description = default(string), string warningCode = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for Warning and cannot be null");
            // to ensure "warningCode" is required (not null)
            this.WarningCode = warningCode ?? throw new ArgumentNullException("warningCode is a required property for Warning and cannot be null");
