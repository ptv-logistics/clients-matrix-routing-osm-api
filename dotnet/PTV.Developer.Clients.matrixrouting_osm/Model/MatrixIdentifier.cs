...
namespace PTV.Developer.Clients.matrixrouting_osm.Model
{
    ...
    public partial class MatrixIdentifier : IEquatable<MatrixIdentifier>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MatrixIdentifier);
        }

        /// <summary>
        /// Returns true if MatrixIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of MatrixIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatrixIdentifier input)
        {
            if (input == null)
                return false;
