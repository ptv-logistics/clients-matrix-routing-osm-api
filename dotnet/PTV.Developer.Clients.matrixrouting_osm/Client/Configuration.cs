...
namespace PTV.Developer.Clients.matrixrouting_osm.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myptv.com/matrixrouting-osm/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.myptv.com/matrixrouting-osm/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.myptv.com/matrixrouting-osm/v1") : this()
        {
        ...
        {
            String report = "C# SDK (PTV.Developer.Clients.matrixrouting_osm) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.2\n";
